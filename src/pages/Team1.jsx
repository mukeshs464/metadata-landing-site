      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-800">
            Project <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-indigo-400">Architecture</span>
          </h2>
            ...
            >
              <div className="flex flex-col">
                ...
                <button
                  ...
                  className="inline-flex justify-center items-center text-center w-full h-10 px-4 py-2 mt-4 text-sm font-medium text-teal-600 bg-teal-100/50 hover:bg-teal-200/70 border border-teal-400/50 rounded-lg transition-all duration-200"
                >
                ...
                <motion.div
                  ...
                  initial="hidden"
                  animate={showDetails[index] ? "visible" : "hidden"}
                  transition={{ duration: 0.3 }}
                  className="mt-4 text-gray-600"
                >
                  <h4 className="text-base font-semibold text-gray-800 mb-2">Details</h4>
